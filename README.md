...
```
 git clone https://github.com/gabigpalharini/barbearia_filo.git
```
...
## Insomnia
[![Run in Insomnia}](https://insomnia.rest/images/run.svg)](https://insomnia.rest/run/?label=Barbearia%20Fil%C3%B3&uri=https%3A%2F%2Fgithub.com%2FClaudiodoSenai%2FBarbearia_filo%2Fblob%2Fmain%2FInsomnia.json)
...
**Aviso**: Certifique-se de substituir "GabiPalharini" no link de clonagem e "claudiorobertojunior5@gmail.com" na seção de contato pelos valores correspondentes do seu próprio usuário do GitHub e endereço de e-mail.
